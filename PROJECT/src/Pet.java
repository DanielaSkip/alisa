...
public class Pet {
    ...
    private static ArrayList<Pet> treatments = new ArrayList<>(); // Типизация списка
    ...
    public double carprofen() {
        if (Objects.equals(species, "Dog")) {
            ...
            return 0; // Если животное не собака и не кошка, дозировка не рассчитывается
        }
    }
    ...
    public static ArrayList<Pet> getTreatments() {  // Типизация возвращаемого списка
        return treatments;
    }

    public static void setTreatments(ArrayList<Pet> treatments) {  // Типизация параметра
